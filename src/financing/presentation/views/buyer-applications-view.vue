<template>
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 space-y-6">
    ...
    <!-- Applications Table matching Mockup Image 3 -->
        ...
        <table class="w-full text-left border-collapse">
          <thead>
            <tr class="border-b border-gray-200 bg-gray-50/70 text-xs font-bold text-gray-700 uppercase tracking-wider">
              ...
              <th scope="col" class="py-4 px-6">Concesionaria</th>
              ...
              <td class="py-4 px-6">
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <span class="text-xs text-gray-400 font-mono">Ref: #{{ item.id }}</span>
                  </div>
                </div>
              </td>
...
const applications = ref<CreditApplication[]>([
  ...
  },
  {
    ...
    concessionaire: 'MegaMotors Santiago',
    date: '10/09/2026',
  ...
  },
  {
    ...
    concessionaire: 'DriveCenter Bogotá',
    date: '28/08/2026',
    status: 'En evaluación'
  },
  {
